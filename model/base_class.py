...
from .base_policy import BasePolicy, get_policy_from_name
...
class BaseAlgorithm(ABC):
    ...
    def _update_learning_rate(self, optimizers: Union[List[th.optim.Optimizer], th.optim.Optimizer]) -> None:
        ...
        logger.record("train/critic_learning_rate", self.lr_schedule(self._current_progress_remaining))
    ...
    def _setup_learn(
        ...
        if self.ep_info_buffer is None or reset_num_timesteps:
            #print("self.ep_info_buffer is None or reset_num_timesteps")
    ...
    def load(self, algo, env, noise,  pos_feature, vel_feature) -> None:  # str, device: Union[th.device, str] = "auto") -> "BaseModel":
        env.reset()
        self.actor.render_rollout(algo, env, noise, pos_feature=pos_feature, vel_feature=vel_feature)
